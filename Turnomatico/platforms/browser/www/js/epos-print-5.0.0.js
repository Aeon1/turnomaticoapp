        ...
        CanvasPrint.prototype.print = function(canvas, printjobid) {
                ...
                if (layout) {
                        builder.addLayout(paper, layout.width, layout.height, layout.margin_top, layout.margin_bottom, layout.offset_cut, layout.offset_label)
                }
                ...
                builder.addImage(canvas.getContext("2d"), 0, 0, canvas.width, canvas.height, this.color, mode);
                if (paper != this.PAPER_RECEIPT) {
